  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return model.onlineDoctorLoader == true ? WholePageLoader() : GestureDetector(
                      ...
                      children: [
                        SizedBox(
                          child: ListView.separated(
                              ...
                              return InkWell(
                                onTap: (){
                                  Navigator.push(context,
                                      PageTransition(type: PageTransitionType.fade, child:  PhysicalVisitBookSlot()));
                                },
                                child: Row(
                                  children: [
                                    // Image.asset(
                                    ...
                                    CachedNetworkImage(
                                        ...
                                        fit: BoxFit.cover,
                                        imageUrl: Constants.imageUrl+model.onlineDoctorModel![index].image!,
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            model.onlineDoctorModel?[index].fullName.toString() ?? '',
                                            style: TextStyle(
                                          ...
                                          Row(
                                            children: [
                                              Text(
                                                model.onlineDoctorModel?[index].qualification ?? '',
                                                style: TextStyle(
                                              ...
                                              Text(
                                                model.onlineDoctorModel?[index].experience ?? '',
                                                style: TextStyle(
                                                  color: ColorUtils.blackShade,
                                                  fontFamily: FontUtils.interRegular,
                                                  fontSize: 1.6.t,
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          model.onlineDoctorModel?[index].fee.toString() ?? "0",
                                          style: TextStyle(
                                            color: ColorUtils.lightGreen,
                                            fontFamily: FontUtils.interSemiBold,
                                            fontSize: 2.t,
                            ...
                            itemCount: model.onlineDoctorModel?.length ?? 0,
                          ),
                        ),
                      ],
                    ),
