  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return model.doctorTypeCatLoader == true ? WholePageLoader() : GestureDetector(
                      ...
                      children: [
                        SizedBox(
                          child: ListView.separated(
                                ...
                                child: Row(
                                  children: [
                                    CachedNetworkImage(
                                        ...
                                        fit: BoxFit.cover,
                                        imageUrl: Constants.imageUrl+model.doctorTypeModel![index].image!,
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            model.doctorTypeModel?[index].title ?? '',
                                            style: TextStyle(
                                          ...
                                          Text(
                                            model.doctorTypeModel?[index].description ?? '',
                                            style: TextStyle(
                            ...
                            itemCount: model.doctorTypeModel?.length ?? 0,
                          ),
                        ),
                      ],
                    ),
