...
class GetDoctorMyHostory {
  ...
  Future getdoctorMyHistory(String token) async {
    try {
      final response = await _dioService.get('appointments/doctor/my-history',
        options: Options(
            headers: {
      ...
      if(response.statusCode == 200){
          ...
          List<DoctorHistoryModel> doctormyhistoryModel = historyData.map((e) => DoctorHistoryModel.fromJson(e)).toList();
