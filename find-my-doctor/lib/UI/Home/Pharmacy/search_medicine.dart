  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MainViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return model.pharmacyBrandsLoader == true || model.pharmacyCategoryLoader == true || model.pharmacyBestSellerLoader ? WholePageLoader() : GestureDetector(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      Navigator.push(
                                          ...
                                          PageTransition(
                                              type: PageTransitionType.fade,
                                              child: CategoryProductList(categoryId: model.pharmacyCategoryModel?[index].id ?? 0,)));
                                    },
                                    child: Container(
                                ...
                                itemCount: model.pharmacyCategoryModel?.length ?? 0),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              CachedNetworkImage(
                                                ...
                                                height: 35.i,
                                                fit: BoxFit.cover,
                                                imageUrl: model.pharmacyBestSellerModel?[index].featuredImg != null ? Constants.imageUrl + model.pharmacyBestSellerModel![index].featuredImg! : '',
                                                errorWidget: (context, url, error) => Image.asset(ImageUtils.tablets),
                                              ),
                                              InkWell(
                                                onTap: () {
                                            ...
                                            children: [
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    model.pharmacyBestSellerModel![index].price.toString(),
                                                    style: TextStyle(
                                                      fontFamily:
                                                      FontUtils.interMedium,
                                                      fontSize: 1.4.t,
                                ...
                                itemCount: model.pharmacyBestSellerModel?.length ?? 0),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                                ...
                                itemCount:
                                    model.pharmacyFrequentlyBought.length),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                                ...
                                itemCount: model.pharmacyBrandsModel?.length ?? 0),
                          ),
                          SizedBox(
                            height: 1.h,
                          ),
